...
def Experiencia(quantidade):
    ...
    """
    exp = item.Item(nome = "Experiência",
        quantidade = quantidade,
        classe = "Experiência",
        classe_batalha = "Experiência",
        fora_batalha = False,
        singular_plural = "singular",
        genero = "F", 
...
def FluidoSlime(quantidade, preco):
    ...
    """
    fluido = item.Item(nome = "Fluido de Slime",
        quantidade = quantidade,
        preco = preco,
        classe = "Material",
        classe_batalha = "Material",
        fora_batalha = False,
        singular_plural = "singular",
        genero = "M",
...
def GlandulaVenenosa(quantidade, preco):
    ...
    """
    glandula = item.Item(nome = "Glândula Venenosa",
        quantidade = quantidade,
        preco = preco,
        classe = "Material",
        classe_batalha = "Material",
...
def CarapacaTortuga(quantidade, preco):
    ...
    """
    casco = item.Item(nome = "Carapaça de Tortuga",
        quantidade = quantidade,
        preco = preco,
        classe = "Material",
        classe_batalha = "Material",
...
def RubiFogo(quantidade, preco):
    ...
    """
    rubi = item.Item(nome = "Rubi de Fogo",
        quantidade = quantidade,
        preco = preco,
        classe = "Material",
        classe_batalha = "Material",
